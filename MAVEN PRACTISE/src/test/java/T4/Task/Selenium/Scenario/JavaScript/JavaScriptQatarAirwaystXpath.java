...
public class JavaScriptQatarAirwaystXpath {

	public static void main(String[] args) {

		System.setProperty("webdriver.chrome.driver",
				"D:\\TESTING REQUIRED APPS JARS\\Chrome 96 drivers\\chromedriver.exe");
		...
		WebElement from = driver.findElement(By.xpath("//*[@id='bw-from']"));
		from.sendKeys("Pu");

		JavascriptExecutor js1 = (JavascriptExecutor) driver;

		// String city="return document.getElementById(\"bw-from\").value;";
		// String city= "document.evaluate(\"//*[@id='bw-from']\", document, null,
		// XPathResult.ANY_TYPE,null).value;";
		String city = "document.evaluate(\"//*[@id='bw-from']\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;";
