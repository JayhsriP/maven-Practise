...
public class MultipleWindowSpring {
public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "D:\\TESTING REQUIRED APPS JARS\\Chrome 96 drivers\\chromedriver.exe");
		 ...
		 // driver.manage().window().maximize();
		  ...
		  WebElement footer=driver.findElement(By.xpath("//*[@id=\"footer-over\"]/div/div[1]/div/div[1]"));
		 ...
		 for(int i=0;i<count;i++)
		 {
		 	...
		 	while(itr.hasNext())
		 	{
		 		...
		 		Thread.sleep(2000);
		 		if(ti.equalsIgnoreCase("Spring | Microservices"))
		 		{
		 			driver.findElement(By.xpath("//*[@id=\"microservices\"]/div[1]/div[2]/section[1]/div/div/p/a")).click();
		 		}
		 	}
		 	driver.close();
}
